...
class Point(object):
    """ represents 2-d point in xy space"""
    ...
    def move_to(self, dx, dy):
        self.Travels += (((self.x - dx) ** 2) + ((self.y - dy) ** 2)) ** 0.5
        self.x = dx
        self.y = dy
        self.moves += 1

    def move_by(self, dx, dy):
        self.Travels += ((dx ** 2) + (dy ** 2)) ** 0.5
        self.x += dx
        self.y += dy
        self.moves += 1
    ...
    def get_distance_from_start(self):
        dx = self.x - self.originx
        dy = self.y - self.originy
        dist = ((dx ** 2) + (dy ** 2)) ** 0.5
        return dist
...
def run_test_repr():
    ...
    """
    # ------------------------------------------------------------------
    # Done: 4.  Follow the same instructions as in 3 above,
...
def run_test_clone():
   ...
   """
    # ------------------------------------------------------------------
    # Done: 5.  Follow the same instructions as in 3 above,
...
def run_test_move_to():
    ...
    """
    # ------------------------------------------------------------------
    # Done: 6.  Follow the same instructions as in  3 above,
...
def run_test_move_by():
    ...
    """
    # ------------------------------------------------------------------
    # Done: 7.  Follow the same instructions as in 3 above,
...
def run_test_get_number_of_moves_made():
    ...
    """
    # ------------------------------------------------------------------
    # Done: 8.  Follow the same instructions as in 3 above,
...
def run_test_get_distance_from():
    ...
    """
    # ------------------------------------------------------------------
    # Done: 9.  Follow the same instructions as in 3 above,
...
def run_test_get_distance_from_start():
    ...
    """
    # ------------------------------------------------------------------
    # Done: 10.  Follow the same instructions as in 3 above,
...
def run_test_get_distance_traveled():
    ...
    """
    # ------------------------------------------------------------------
    # Done: 11.  Follow the same instructions as in  3 above,
...
def run_test_closer_to():
    ...
    """
    # ------------------------------------------------------------------
    # Done: 12.  Follow the same instructions as in  3 above,
...
def run_test_halfway_to():
    ...
    """
    # ------------------------------------------------------------------
    # Done: 13.  Follow the same instructions as in  3 above,
